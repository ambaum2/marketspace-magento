...
class MS_Ship_Model_Rates_Totals_Product_By_Weight extends Mage_Core_Model_Abstract
{
  var $price;
  var $cost;
  var $line_item_info; //array of line items
    ...
    public function get($_item, $_product) {
      try {
        $this->price = $_product['ms_shipping_cost'] * $_item->getQty() * $_product['weight'];
        $this->cost = $_product['ms_shipping_cost'] * $_item->getQty() * $_product['weight'];
