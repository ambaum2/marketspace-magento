...
class MS_Ship_Model_Products_Rates_Totals_Product extends Mage_Core_Model_Abstract
{
  var $price;
  var $cost;
  var $line_item_info; //array of line items
    ...
    public function get($_item, $_product) {
      try {
        $this->price = $_product['ms_shipping_cost'] * $_item->getQtyOrdered();
        $this->cost = $_product['ms_shipping_cost'] * $_item->getQtyOrdered();
