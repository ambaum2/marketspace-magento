...
class MS_Api_Model_Reports_Owners_Orders_Types_AllOrdersDetails extends Mage_Core_Model_Abstract implements MS_Api_Model_Service {
    public $Adapter;
    public $Uid;
    /**
    ...
    public function get()
    {
        ...
        $result = $this->Daa->GetAllOwnersOrders($this->Uid);
        return $result;
    }
