        ...
        <form method="post" action="'.$post_url.'">
            ...
            <fieldset>
                <div>
                    ...
                    <input type="text" class="text" size="15" name="x_card_num" value="'.($prefill ? '' : '').'"></input>
                </div>
                <div>
                    <label>Exp. (MM/YY) 02/12</label>
                    <input type="text" class="text" size="4" name="x_exp_date" value="'.($prefill ? '' : '').'"></input>
                </div>
                <div>
                    <label>CCV</label>
