...
define("AUTHORIZENET_API_LOGIN_ID","522LbKuKU");    // Add your API LOGIN ID
define("AUTHORIZENET_TRANSACTION_KEY","5FsHc24t2GZt2w6D"); // Add your API transaction key
...
$site_root = "https://escapelocally.com"; // Add the URL to your site
